...
| 3 — Sandbox interaction | Complete | 3D laboratory, world builder, agent dock, inspector, telemetry, export, accessibility |
| 4 — Performance architecture | Not started | Requires representative-scene profiling |
