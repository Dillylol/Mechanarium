...
- Ramp/beam center dragging, angle/length gizmos, numeric center/angle/length inspection, start markers, track snapping, and release placement.
- Draggable connector endpoints with world anchors and port snapping; manual port-to-port Rigid/Pin workflow.
...
- 42 automated tests across nine files.
